...
Pin `@v1.4.0`, `@v1`, or a full commit SHA from [releases](https://github.com/chaintrap-sec/scan-action/releases). Pin helper actions to SHAs (see [consumer-workflow.yml](consumer-workflow.yml)).
